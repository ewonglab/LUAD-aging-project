...
expression_matrix = Read10X(
        data.dir ='./IGO_028760/outs/filtered_feature_bc_matrix/',
        gene.column = 2,
...
ggsave("hto_IGO_028760_filtered_feature_bc_matrix.pdf")
...
library(dplyr)
bc_info=bc_info %>% filter(X10x.submission.ID=="IGO-028760")
bc_info=bc_info[which(bc_info$Hashtag != 'B0307'),]
...
obj
saveRDS(obj, file="IGO_028760.rds")
