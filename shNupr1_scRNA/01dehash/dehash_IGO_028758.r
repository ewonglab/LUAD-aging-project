...
expression_matrix = Read10X(
        data.dir ='./IGO_028758/outs/filtered_feature_bc_matrix/',
        gene.column = 2,
...
ggsave("hto_IGO_028758_filtered_feature_bc_matrix.pdf")
...
library(dplyr)
bc_info=bc_info %>% filter(X10x.submission.ID=="IGO-028758")
...
obj
saveRDS(obj, file="IGO_028758.rds")
