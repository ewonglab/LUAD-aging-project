...
sub_meta=subset(meta,  cl_epithelial_tumor_pca=='AT1-like' & tumor_stage != 'healthy')
...
library(xlsx)
write.xlsx(fcHurdleSig, file="/g/data/zk16/qing/tuomas/simon/MAST/MAST_AT1like_agedvsyoung.xlsx")
